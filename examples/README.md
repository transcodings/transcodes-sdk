...
| 앱 | 포트 | 명령어 |
|---|---|---|
| Next.js 15 (App Router) | 3010 | `cd examples/nextjs && npm install && npm run dev` |
| SvelteKit (Svelte 5) | 3011 | `cd examples/sveltekit && npm install && npm run dev` |
| Vite + React 19 | 3012 | `cd examples/vite-react && npm install && npm run dev` |
| Vue 3 + Vite | 3013 | `cd examples/vue-vite && npm install && npm run dev` |
